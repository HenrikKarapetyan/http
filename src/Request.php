...
use Henrik\Http\Containers\InputBag;
use Henrik\Http\Containers\ParameterBag;
use Henrik\Http\Containers\ServerBag;
use Henrik\Http\Exception\ConflictingHeadersException;
...
class Request implements RequestInterface
{
    ...
    protected null|Closure|SessionInterface $session = null;
    ...
    {
        self::$requestFactory = $callable === null ? null : $callable(...);
    }
